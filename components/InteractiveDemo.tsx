      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <p 
            ...
            ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            Transform your digital presence with cutting-edge augmented reality solutions
          </p>
          ...
          {demoCards.map((card, index) => (
            ...
            >
              <div className={`relative bg-white rounded-2xl p-8 h-full transition-all duration-500 
                ...
                <div className={`absolute inset-x-0 -top-px h-px w-full bg-gradient-to-r ${card.gradient} 
                  transform origin-left transition-transform duration-500 
                  ${activeCard === index ? 'scale-x-100' : 'scale-x-0'}`} />
                
                <div className={`p-4 rounded-lg bg-gradient-to-br ${card.gradient} 
