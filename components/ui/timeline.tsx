...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  // Adjusted spring animation to be more responsive
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Two years of pushing the boundaries of AR & VR—here's my journey.
        </motion.p>
      </motion.div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          return (
            ...
            >
              <motion.div 
                ...
                transition={{ duration: 0.4, delay: index * 0.1 }} // Reduced delay
              >
                <motion.div 
                ...
                >
                  <motion.div 
                    ...
                    animate={{ 
                      scale: isInView ? [1, 1.1, 1] : 1 // Reduced scale
                    }}
        ...
        {/* Simplified vertical line with subtle animation */}
        <div className="absolute md:left-8 left-8 top-0 w-[2px] h-full">
          ...
          {/* Progress line with gentler animation */}
          <motion.div
            style={{
          ...
          {/* Subtle dots with faster appearance */}
          {[...Array(6)].map((_, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0 }}
